class FilterGroupController < ApplicationController
  ...
  def filter_group_params
    params.require(:filter_group).permit(:name, :type, filter_category_attributes: [:category_name, :filter_group_id], filter_in_category_attributes: [:filter_name, :sort_order, :filter_group_id])
  end
end
