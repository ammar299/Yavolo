class Seller < ApplicationRecord
  ...
  enum timeout: {
    ...
    "After 2 hours of no activity": 2,
    "After 3 hours of no activity": 3,
    "After 4 hours of no activity": 4,
    "After 5 hours of no activity": 5,
    "After 6 hours of no activity": 6,
    "After 7 hours of no activity": 7,
    "After 8 hours of no activity": 8,
    "After 9 hours of no activity": 9,
    "After 10 hours of no activity": 10,
    "After 11 hours of no activity": 11,
    "After 12 hours of no activity": 12,
    "After 24 hours of no activity": 24,
  }
  enum account_status: {
    pending: 0,
    approve: 1,
  ...
  def to_csv(all_sellers)
    attributes = %w{user_email user_first_name user_surname account_status listing_status subscription_type uid company_name
