module Sellers::OrdersHelper
  ...
  def seller_order_current_search_field_name
    ...
    valid_field_names.include?(params[:csfname]) ? params[:csfname] : 'line_items_product_title_or_order_detail_full_name_or_shipping_address_postal_code_or_billing_address_postal_code_or_line_items_product_sku_or_line_items_product_yan_or_line_items_product_ean_or_order_number_cont'
  end
  ...
  def seller_order_search_field_query_param_val(q_params)
    [
      ...
      q_params[:q][:line_items_product_title_or_order_detail_full_name_or_shipping_address_postal_code_or_billing_address_postal_code_or_line_items_product_sku_or_line_items_product_yan_or_line_items_product_ean_or_order_number_cont]
